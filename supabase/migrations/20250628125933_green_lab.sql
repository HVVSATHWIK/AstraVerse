/*
  # Metrics Table for Dashboard KPIs - Idempotent Version

  This migration creates the metrics table if it doesn't already exist.
  All operations are wrapped in conditional checks to ensure they can be run multiple times safely.
*/
...
-- Create or replace the function to get the latest metrics for a user
